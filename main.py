...
moves = [
    ...
    [9, 11, 17, 15, 10, 14, 16, 12, 2, 51, 29,
        20, 5, 48, 32, 23, 8, 45, 35, 26],  # R
    [18, 20, 26, 24, 19, 23, 25, 21, 6, 9, 29,
        44, 7, 12, 28, 41, 8, 15, 27, 38],  # F
    [27, 29, 35, 33, 28, 32, 34, 30, 24, 15, 51,
        42, 25, 16, 52, 43, 26, 17, 53, 44],  # D
    [36, 38, 44, 42, 37, 41, 43, 39, 0, 18, 27,
        53, 3, 21, 30, 50, 6, 24, 33, 47],  # L
    [45, 47, 53, 51, 46, 50, 52, 48, 2, 36, 33,
        17, 1, 39, 34, 14, 0, 42, 35, 11]  # B
]
...
def draw_stickers(offx=5, offy=5, gray=False):
    global PatternSize, PatternOffsetX, PatternOffsetY
    PatternOffsetX = offx
    PatternOffsetY = offy
    ...
    def draw_sticker(pos):
        ...
        Canvas.create_rectangle(
            x, y, x+ps, y+ps, fill=color, outline="#000000", width="3")
        Canvas.pack()
